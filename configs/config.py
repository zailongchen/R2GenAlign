...
parser.add_argument('--triple_dir', type=str, default="/home/guest/czl/dataset/mimic_cxr/prompt", help="base dir to help find prompt data")
...
parser.add_argument('--clinicalbert', default='/home/guest/czl/pretrained_models/bio_clinicalbert', type=str, help="text encoder model to use bio_clinicalbert")
parser.add_argument('--mapping_layer', default='mlp', type=str, help='mlp or qformer')
