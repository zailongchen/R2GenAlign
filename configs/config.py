...
parser = argparse.ArgumentParser(description="hyper-parameter for R2GenAlign")
# ========================= Dataset Configs ==========================
...
parser.add_argument('--llama_model', default='meta-llama/Llama-2-7b-chat-hf', type=str, help="LLM model to use  Llama-2-7b-chat-hf")
parser.add_argument('--clinicalbert', default='emilyalsentzer/Bio_ClinicalBERT', type=str, help="text encoder model to use bio_clinicalbert")
...
parser.add_argument('--visual_ckpt_file', type=str, default=None, help='the delta file to load')
